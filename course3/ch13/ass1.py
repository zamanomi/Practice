...
#Actual data: http://py4e-data.dr-chuck.net/comments_1484176.xml (Sum ends with 4)
...
#The closest sample code that shows how to parse XML is geoxml.py. But since the nesting of
#the elements in our data is different than the data we are parsing in that sample code you
#will have to make real changes to the code.
...
#for details. You could also work from the top of the XML down to the comments node and then
#loop through the child nodes of the comments node.

import urllib.request, urllib.parse, urllib.error
import xml.etree.ElementTree as ET

url = urllib.request.urlopen('http://py4e-data.dr-chuck.net/comments_1479962.xml').read()
