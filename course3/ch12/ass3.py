...
#in the list, follow that link and repeat the process a number of times and report the last name
#you find.
...
#Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Makin.html
...
#little effort and patience you can overcome these attempts to make it a little harder to
#complete the assignment without writing a Python program. But that is not the point. The point
...
repeat = int(input('Enter number of repeatations: ')) #range=7
